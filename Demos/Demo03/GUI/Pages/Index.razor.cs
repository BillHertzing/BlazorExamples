...
namespace GUI.Pages {
    public class IndexCodeBehind : ComponentBase {
        ...
        public void IncrementAnIntegerPropertyButtonOnClickHandler() {
            Logger.LogDebug("Starting IncrementAnIntegerPropertyButtonOnClickHandler");
            AnIntegerProperty+=1;
            Logger.LogDebug("Leaving IncrementAnIntegerPropertyButtonOnClickHandler");
        }
