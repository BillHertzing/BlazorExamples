...
namespace Server {
    ...
    public class SSAppHost : AppHostBase {
        ...
        public override void Configure(Container container) {
            ...
            //Log.Debug($"in SSAppHost.Configure, base.Configuration.GetValue<String>(Program.URLSConfigRootKey).Dump() = {Configuration.GetValue<String>(Program.URLSConfigRootKey).Dump()}");
