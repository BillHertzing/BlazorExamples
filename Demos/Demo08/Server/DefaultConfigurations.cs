...
namespace Server {
    partial class Program {
        ...
        new Dictionary<string, string>
        {
            ...
            // {"urls", "http://localhost:20820/"}, // ToDo: investigate the impact of UseIIS on urls, and the location of UseIIS in the static generichostbuilder
        };
        ...
        new Dictionary<string, string>
        {
            ...
            // {"urls", "http://localhost:20810/"}, // ToDo: investigate the impact of UseIIS on urls, and the location of UseIIS in the static generichostbuilder
        };
