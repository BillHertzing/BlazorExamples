...
namespace GUI.Pages {
    public class IndexCodeBehind : ComponentBase {
        ...
        //  The structure is populated via the page lifecycle event OnInitializedAsync
        ...
        protected override async Task OnInitializedAsync() {
            ...
            Logger.LogDebug($"AnIntegerPropertyTextSpanStyle = {AnIntegerPropertyTextSpanStyle}");
            #endregion
