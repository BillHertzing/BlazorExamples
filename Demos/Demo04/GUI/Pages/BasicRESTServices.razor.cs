...
namespace GUI.Pages {
    public class BasicRESTServicesCodeBehind : ComponentBase
    {
        ...
        protected override async Task OnInitAsync()
        {
            ...
            IServiceClient client = new ServiceStack.JsonServiceClient("http://localhost:21100");
            ...
            InitializationRspDTO = await client.PostAsync<InitializationRspDTO>(uriBuilder.Uri.ToString(),
