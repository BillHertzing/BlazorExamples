...
namespace ConsoleApp
{
  ...
  public class AppHost : AppSelfHostBase {
    ...
    public override void Stop() {
      ...
      // This sample does not have any objects to dispose, but this override provides logging of when the Stop method is called
    ...
    public override void Configure(Container container) {
      ...
      // This example is built inside of Visual Studio 2017, with both the Console Host and the GUI projects sharing the same parent directory, the $SolutionDir.
      // When the Console App is run inside of VS by hitting F5 or shift-F5, VS builds the Console App in
      ...
      // Assuming you build and run this example in CS 2017 set to Debug configuration
      ...
      {
        Log.Debug($"In AppHost.Configure, got an exception whne attempting to create a new virtual to physical file system mapping: {e.Message}");
